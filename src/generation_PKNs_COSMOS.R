...
cosmos.pkn.mm <- create_PKN_COSMOS( 
  ...
  stitch.actions.file = file.path(projectPath, "data/Mouse-PKN/10090.actions.v5.0.tsv"), 
  stitch.links.file = file.path(projectPath, "data/Mouse-PKN/10090.protein_chemical.links.detailed.v5.0.tsv")
)
...
cosmos.pkn.rn <- create_PKN_COSMOS( 
  ...
  stitch.actions.file = file.path(projectPath, "data/Rat-PKN/10116.actions.v5.0.tsv"), 
  stitch.links.file = file.path(projectPath, "data/Rat-PKN/10116.protein_chemical.links.detailed.v5.0.tsv")
)
